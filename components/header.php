<header class="header header-sticky p-0 mb-4">
  <div class="container-fluid border-bottom px-4">
    ...
    <ul class="header-nav d-none d-lg-flex">
      ...
      <li class="nav-item"><a class="nav-link" href="../public/pengguna.php">Users</a></li>
      <li class="nav-item"><a class="nav-link" href="../public/transaksi.php">Transaction</a></li>
    </ul>
    ...
    <ul class="header-nav">
      ...
      <li class="nav-item dropdown"><a class="nav-link py-0 pe-0" data-coreui-toggle="dropdown" href="#" role="button"
          ...
          <div class="avatar avatar-md"><img class="avatar-img" src="../assets/img/avatars/10.jpg" alt="user@email.com">
          </div>
        </a>
